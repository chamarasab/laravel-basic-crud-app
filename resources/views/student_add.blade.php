...
<main class="form-signin w-100 m-auto">
    <form method="post" action="{{ route('add.student') }}">
        ...
        <img src="https://img.icons8.com/fluency/144/null/cookie-monster.png"/>
        <h1 class="h3 my-3 fw-normal">Add New Student</h1>
        ...
        <a class="w-100 mt-1 btn btn-lg btn-warning" href="{{ route('view.students') }}">View</a>
        <p class="mt-5 mb-3 text-muted">&copy; ABC School</p>
    </form>
</main>
